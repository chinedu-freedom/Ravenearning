...
function ReceiptContent() {
  ...
  const symbol = settingsRes?.settings?.currency_symbol || "R";
    ...
    <div className="flex flex-col h-full bg-transparent overflow-y-auto [&::-webkit-scrollbar]:hidden pb-32">
      ...
      <div className="px-4 max-w-[480px] mx-auto w-full flex-1 flex flex-col items-center pt-6">
        ...
        >
          ...
          <div className="w-full bg-[#0b0f19] border-l-[3px] border-[#4f8cff] rounded-r-[8px] p-3 mt-2 relative z-10">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#111827] border-t border-white/5 pb-6 pt-4 px-4 z-50">
        <div className="max-w-[480px] mx-auto w-full flex gap-3">
          <button 
            ...
            className="flex-1 bg-[#0b0f19] border border-white/10 text-[#4f8cff] flex items-center justify-center gap-2 py-3.5 rounded-[12px] text-[13px] font-medium hover:bg-white/5 active:scale-[0.98] transition-all shadow-sm cursor-pointer"
          >
