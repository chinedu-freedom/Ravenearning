      ...
      <div className="px-4 pt-4 pb-4 max-w-[480px] mx-auto w-full flex-1">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-red-400 bg-[#111827] rounded-[16px] border border-white/5 shadow-sm">
            ...
            <Link href="/dashboard/news" className="mt-4 text-[#4f8cff] text-xs font-bold underline cursor-pointer">
              Return to News
            </Link>
          </div>
        ) : (
          <div className="bg-[#111827] rounded-[16px] p-[20px] border border-white/5 shadow-sm">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="text-[9px] font-bold px-2 py-0.5 rounded bg-blue-900/20 text-[#4f8cff] flex items-center gap-1">
            ...
            {article.image ? (
              ...
              <div className="w-full h-[140px] bg-gradient-to-r from-[#4f8cff] to-[#0f172a] rounded-xl mb-6 shadow-inner relative overflow-hidden flex items-center justify-center border border-white/5">
