...
export default function AccountPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#070c14] text-white pb-24 font-sans">
      ...
      {/* Main Action Options (Single Grid Container) */}
      <div className="px-5 mt-6 space-y-4 max-w-[480px] mx-auto w-full">

        {/* Single Menu Grid Container */}
        <div className="bg-[#111827] rounded-[22px] p-4 border border-white/10 shadow-xl grid grid-cols-3 sm:grid-cols-4 gap-y-6 gap-x-2 items-center">
          ...
          >
            <div className="w-11 h-11 rounded-[14px] bg-blue-900/20 border border-white/5 flex items-center justify-center text-[#4f8cff] group-hover:scale-105 transition-transform">
          ...
          <Link
            ...
            className="flex flex-col items-center justify-center px-1 py-1 group hover:opacity-80 transition-opacity cursor-pointer text-center"
          >
            <div className="w-11 h-11 rounded-[14px] bg-sky-900/20 border border-white/5 flex items-center justify-center text-[#38bdf8] group-hover:scale-105 transition-transform">
