        ...
        <div className="bg-[#111827] rounded-[16px] border border-white/5 shadow-sm p-6">
          ...
          {step === 1 && (
            <button
              ...
              disabled={isSending}
              className="w-full bg-gradient-to-r from-[#4f8cff] to-[#6ee7ff] hover:opacity-95 text-white font-bold text-[15px] py-3.5 rounded-[12px] transition-all shadow-md cursor-pointer disabled:opacity-50 flex items-center justify-center gap-2"
            >
            ...
            <form onSubmit={handleVerify} className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-[#0b0f19] border border-white/10 rounded-[12px] px-4 py-4 text-[16px] text-center tracking-[0.4em] font-medium text-white/90 placeholder-gray-500 focus:outline-none focus:border-[#4f8cff] transition-all"
                  maxLength={6}
                />
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-[#4f8cff] to-[#6ee7ff] hover:opacity-95 text-white font-bold text-[15px] py-3.5 rounded-[12px] transition-all shadow-md cursor-pointer disabled:opacity-50"
              >
              ...
              <div className="text-center pt-2">
                <p className="text-[13px] text-gray-500">
                  ...
                  <button 
                    ...
                    onClick={handleSendCode} 
                    disabled={isSending}
                    className="text-[#4f8cff] hover:underline disabled:opacity-50 font-medium ml-1 cursor-pointer"
                  >
                    Resend
                  </button>
                </p>
